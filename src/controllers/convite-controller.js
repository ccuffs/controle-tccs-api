...
router.put("/:id/:codigo_docente",  auth.autenticarUsuario,
	autorizacao.verificarPermissao([
...
router.delete("/:id/:codigo_docente",  auth.autenticarUsuario,
	autorizacao.verificarPermissao([
		Permissoes.TRABALHO_CONCLUSAO.DELETAR,
	]),conviteService.deletaConvite);

// GET /api/convites/pendentes/:codigo - Retorna convites pendentes de um docente
router.get("/pendentes/:codigo",  auth.autenticarUsuario,
	autorizacao.verificarPermissao([
		Permissoes.TRABALHO_CONCLUSAO.VISUALIZAR,
		Permissoes.TRABALHO_CONCLUSAO.VISUALIZAR_TODOS,
	]),conviteService.retornaConvitesPendentesDocente);
